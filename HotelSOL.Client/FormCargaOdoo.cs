...
namespace HotelSOL
{
    public partial class FormCargaOdoo : Form
    {
        ...
        {
            ScriptRunner.EjecutarScriptPython(@"Habitaciones\sincronizar_disponibilidad.py");
        }

        private void btnCuentasContables_Click(object sender, EventArgs e)
        {
            ScriptRunner.EjecutarScriptPython(@"establecer_cuenta_contable.py");
        }
    }
}
